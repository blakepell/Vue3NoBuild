namespace Vue3NoBuild.Common
{
    ...
    /// to track and assist in clearing individual cache items.  The existence of a key does not
    /// mean it still exists in the cache but rather that it did exist.
    /// </summary>
    public class CacheProvider
    {
        ...
        public T Get<T>(string cacheKey, Func<T> getItemFunc)
        {
            ...
            return this.Get(cacheKey, defaultCacheOptions, getItemFunc);
        }
